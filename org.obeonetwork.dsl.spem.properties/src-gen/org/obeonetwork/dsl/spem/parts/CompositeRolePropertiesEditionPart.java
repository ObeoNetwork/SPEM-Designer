 ...
 * 
 */
public interface CompositeRolePropertiesEditionPart {
	...
	/**
	 * Init the appliedQualification
	 * @param settings settings for the appliedQualification ReferencesTable 
	 */
	public void initAppliedQualification(ReferencesTableSettings settings);

	/**
	 * Update the appliedQualification
	 * @param newValue the appliedQualification to update
	 * 
	 */
	public void updateAppliedQualification();

	/**
	 * Adds the given filter to the appliedQualification edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the appliedQualification table
	 * 
	 */
	...
	/**
	 * Init the aggregatedRole
	 * @param settings settings for the aggregatedRole ReferencesTable 
	 */
	public void initAggregatedRole(ReferencesTableSettings settings);

	/**
	 * Update the aggregatedRole
	 * @param newValue the aggregatedRole to update
	 * 
	 */
	public void updateAggregatedRole();

	/**
	 * Adds the given filter to the aggregatedRole edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the aggregatedRole table
	 * 
	 */
