 ...
 * 
 */
public interface Default_TaskDefinitionPerformerPropertiesEditionPart {
	...
	/**
	 * @return the linkedTaskDefinition
	 * 
	 */
	public EObject getLinkedTaskDefinition();

	/**
	 * Init the linkedTaskDefinition
	 * @param settings the combo setting
	 */
	public void initLinkedTaskDefinition(EObjectFlatComboSettings settings);

	/**
	 * Defines a new linkedTaskDefinition
	 * @param newValue the new linkedTaskDefinition to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the linkedTaskDefinition edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
