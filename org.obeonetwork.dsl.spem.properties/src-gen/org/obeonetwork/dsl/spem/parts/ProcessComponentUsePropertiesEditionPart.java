 ...
 * 
 */
public interface ProcessComponentUsePropertiesEditionPart {
	...
	/**
	 * @return the processComponent
	 * 
	 */
	public EObject getProcessComponent();

	/**
	 * Init the processComponent
	 * @param settings the combo setting
	 */
	public void initProcessComponent(EObjectFlatComboSettings settings);

	/**
	 * Defines a new processComponent
	 * @param newValue the new processComponent to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the processComponent edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
