 ...
 * 
 */
public interface Default_ResponsibilityAssignmentPropertiesEditionPart {
	...
	/**
	 * Init the linkedRoleDefinition
	 * @param settings settings for the linkedRoleDefinition ReferencesTable 
	 */
	public void initLinkedRoleDefinition(ReferencesTableSettings settings);

	/**
	 * Update the linkedRoleDefinition
	 * @param newValue the linkedRoleDefinition to update
	 * 
	 */
	public void updateLinkedRoleDefinition();

	/**
	 * Adds the given filter to the linkedRoleDefinition edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the linkedRoleDefinition table
	 * 
	 */
	...
	/**
	 * @return the linkedWorkProductDefinition
	 * 
	 */
	public EObject getLinkedWorkProductDefinition();

	/**
	 * Init the linkedWorkProductDefinition
	 * @param settings the combo setting
	 */
	public void initLinkedWorkProductDefinition(EObjectFlatComboSettings settings);

	/**
	 * Defines a new linkedWorkProductDefinition
	 * @param newValue the new linkedWorkProductDefinition to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the linkedWorkProductDefinition edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
