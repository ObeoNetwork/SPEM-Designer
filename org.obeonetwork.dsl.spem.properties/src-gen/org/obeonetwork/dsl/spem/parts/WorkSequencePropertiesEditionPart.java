 ...
 * 
 */
public interface WorkSequencePropertiesEditionPart {
	...
	/**
	 * Defines a new linkKind
	 * @param newValue the new linkKind to set
	 * 
	 */
	...
	/**
	 * Init the predecessor
	 * @param settings the combo setting
	 */
	public void initPredecessor(EObjectFlatComboSettings settings);

	/**
	 * Defines a new predecessor
	 * @param newValue the new predecessor to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the predecessor edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Defines a new successor
	 * @param newValue the new successor to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the successor edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
