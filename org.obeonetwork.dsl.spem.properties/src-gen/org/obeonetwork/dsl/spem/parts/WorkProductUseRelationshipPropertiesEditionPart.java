 ...
 * 
 */
public interface WorkProductUseRelationshipPropertiesEditionPart {
	...
	/**
	 * @return the relationshipKind
	 * 
	 */
	public Enumerator getRelationshipKind();

	/**
	 * Init the relationshipKind
	...
	/**
	 * Defines a new relationshipKind
	 * @param newValue the new relationshipKind to set
	 * 
	 */
