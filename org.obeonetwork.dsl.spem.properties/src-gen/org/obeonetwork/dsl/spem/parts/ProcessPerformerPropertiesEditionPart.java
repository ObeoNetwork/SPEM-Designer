 ...
 * 
 */
public interface ProcessPerformerPropertiesEditionPart {
	...
	/**
	 * Init the linkedRoleUse
	 * @param settings settings for the linkedRoleUse ReferencesTable 
	 */
	public void initLinkedRoleUse(ReferencesTableSettings settings);

	/**
	 * Update the linkedRoleUse
	 * @param newValue the linkedRoleUse to update
	 * 
	 */
	public void updateLinkedRoleUse();

	/**
	 * Adds the given filter to the linkedRoleUse edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the linkedRoleUse table
	 * 
	 */
	...
	/**
	 * @return the linkedActivity
	 * 
	 */
	public EObject getLinkedActivity();

	/**
	 * Init the linkedActivity
	 * @param settings the combo setting
	 */
	public void initLinkedActivity(EObjectFlatComboSettings settings);

	/**
	 * Defines a new linkedActivity
	 * @param newValue the new linkedActivity to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the linkedActivity edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return the linkedTaskUse
	 * 
	 */
	public EObject getLinkedTaskUse();

	/**
	 * Init the linkedTaskUse
	 * @param settings the combo setting
	 */
	public void initLinkedTaskUse(EObjectFlatComboSettings settings);

	/**
	 * Defines a new linkedTaskUse
	 * @param newValue the new linkedTaskUse to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the linkedTaskUse edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
