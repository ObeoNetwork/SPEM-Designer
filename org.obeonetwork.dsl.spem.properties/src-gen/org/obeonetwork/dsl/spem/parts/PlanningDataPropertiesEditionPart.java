 ...
 * 
 */
public interface PlanningDataPropertiesEditionPart {
	...
	/**
	 * Defines a new startDate
	 * @param newValue the new startDate to set
	 * 
	 */
	...
	/**
	 * Defines a new finishDate
	 * @param newValue the new finishDate to set
	 * 
	 */
	...
	/**
	 * Defines a new rank
	 * @param newValue the new rank to set
	 * 
	 */
