 ...
 * 
 */
public interface WorkProductPortConnectorPropertiesEditionPart {
	...
	/**
	 * Init the connectedPort
	 * @param settings settings for the connectedPort ReferencesTable 
	 */
	public void initConnectedPort(ReferencesTableSettings settings);

	/**
	 * Update the connectedPort
	 * @param newValue the connectedPort to update
	 * 
	 */
	public void updateConnectedPort();

	/**
	 * Adds the given filter to the connectedPort edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the connectedPort table
	 * 
	 */
