 ...
 * 
 */
public interface TaskDefinitionPropertiesEditionPart {
	...
	/**
	 * Init the ownedTaskDefinitionParameter
	 * @param current the current value
	...
	/**
	 * Update the ownedTaskDefinitionParameter
	 * @param newValue the ownedTaskDefinitionParameter to update
	 * 
	 */
	public void updateOwnedTaskDefinitionParameter();

	/**
	 * Adds the given filter to the ownedTaskDefinitionParameter edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the ownedTaskDefinitionParameter table
	 * 
	 */
	...
	/**
	 * Init the usedTool
	 * @param settings settings for the usedTool ReferencesTable 
	 */
	public void initUsedTool(ReferencesTableSettings settings);

	/**
	 * Update the usedTool
	 * @param newValue the usedTool to update
	 * 
	 */
	public void updateUsedTool();

	/**
	 * Adds the given filter to the usedTool edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the usedTool table
	 * 
	 */
	...
	/**
	 * Init the requiredQualification
	 * @param settings settings for the requiredQualification ReferencesTable 
	 */
	public void initRequiredQualification(ReferencesTableSettings settings);

	/**
	 * Update the requiredQualification
	 * @param newValue the requiredQualification to update
	 * 
	 */
	public void updateRequiredQualification();

	/**
	 * Adds the given filter to the requiredQualification edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the requiredQualification table
	 * 
	 */
