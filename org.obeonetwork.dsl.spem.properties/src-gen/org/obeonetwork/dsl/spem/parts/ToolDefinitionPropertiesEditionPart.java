 ...
 * 
 */
public interface ToolDefinitionPropertiesEditionPart {
	...
	/**
	 * Init the managedWorkProduct
	 * @param settings settings for the managedWorkProduct ReferencesTable 
	 */
	public void initManagedWorkProduct(ReferencesTableSettings settings);

	/**
	 * Update the managedWorkProduct
	 * @param newValue the managedWorkProduct to update
	 * 
	 */
	public void updateManagedWorkProduct();

	/**
	 * Adds the given filter to the managedWorkProduct edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the managedWorkProduct table
	 * 
	 */
