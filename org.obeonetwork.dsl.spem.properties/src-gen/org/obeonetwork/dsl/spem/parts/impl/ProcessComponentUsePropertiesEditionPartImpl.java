...
public class ProcessComponentUsePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProcessComponentUsePropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.kind, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createPresentationNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.presentationName, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.briefDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createMainDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.mainDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createPurposeText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.purpose, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createCopyrightText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.copyright, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(SpemMessages.ProcessComponentUsePropertiesEditionPart_AuthorLabel);
	...
	protected Composite createChangeDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.changeDate, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.changeDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createVersionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.version, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.name, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(SpemMessages.ProcessComponentUsePropertiesEditionPart_HasMultipleOccurrencesLabel);
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(SpemMessages.ProcessComponentUsePropertiesEditionPart_IsOptionalLabel);
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(SpemMessages.ProcessComponentUsePropertiesEditionPart_IsPlannedLabel);
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(Composite parent) {
		...
		isSynchronizedWithSource.setText(SpemMessages.ProcessComponentUsePropertiesEditionPart_IsSynchronizedWithSourceLabel);
	...
	protected Composite createProcessComponentFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.ProcessComponentUsePropertiesEditionPart_ProcessComponentLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessComponentUse.Properties.processComponent, SpemViewsRepository.SWT_KIND));
