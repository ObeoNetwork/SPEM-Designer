...
public class WorkProductDefinitionRelationshipPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, WorkProductDefinitionRelationshipPropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.kind, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createPresentationNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.presentationName, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.briefDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createMainDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.mainDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createPurposeText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.purpose, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createCopyrightText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.copyright, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_AuthorLabel);
	...
	protected Composite createChangeDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.changeDate, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.changeDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createVersionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.version, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.name, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createVariabilityTypeEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_VariabilityTypeLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.variabilityType, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_VariabilityBasedOnElementLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.variabilityBasedOnElement, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createMethodContentKindFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_MethodContentKindLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.methodContentKind, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createSourceFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.source, SpemViewsRepository.SWT_KIND));
