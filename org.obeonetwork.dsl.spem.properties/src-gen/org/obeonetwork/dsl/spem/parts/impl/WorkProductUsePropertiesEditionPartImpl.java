...
public class WorkProductUsePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, WorkProductUsePropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.kind, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createPresentationNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.presentationName, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.briefDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createMainDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.mainDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createPurposeText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.purpose, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createCopyrightText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.copyright, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(SpemMessages.WorkProductUsePropertiesEditionPart_AuthorLabel);
	...
	protected Composite createChangeDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.changeDate, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.changeDescription, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createVersionText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.version, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.name, SpemViewsRepository.SWT_KIND));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(SpemMessages.WorkProductUsePropertiesEditionPart_HasMultipleOccurrencesLabel);
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(SpemMessages.WorkProductUsePropertiesEditionPart_IsOptionalLabel);
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(SpemMessages.WorkProductUsePropertiesEditionPart_IsPlannedLabel);
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(Composite parent) {
		...
		isSynchronizedWithSource.setText(SpemMessages.WorkProductUsePropertiesEditionPart_IsSynchronizedWithSourceLabel);
	...
	protected Composite createWorkProductFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, SpemMessages.WorkProductUsePropertiesEditionPart_WorkProductLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.WorkProductUse.Properties.workProduct, SpemViewsRepository.SWT_KIND));
