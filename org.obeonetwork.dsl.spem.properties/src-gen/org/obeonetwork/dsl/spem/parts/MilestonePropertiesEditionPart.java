 ...
 * 
 */
public interface MilestonePropertiesEditionPart {
	...
	/**
	 * Init the requiredResult
	 * @param settings settings for the requiredResult ReferencesTable 
	 */
	public void initRequiredResult(ReferencesTableSettings settings);

	/**
	 * Update the requiredResult
	 * @param newValue the requiredResult to update
	 * 
	 */
	public void updateRequiredResult();

	/**
	 * Adds the given filter to the requiredResult edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the requiredResult table
	 * 
	 */
