 ...
 * 
 */
public interface RoleDefinitionPropertiesEditionPart {
	...
	/**
	 * Defines a new synonym
	 * @param newValue the new synonym to set
	 * 
	 */
	public void setSynonym(EList newValue);

	/**
	 * Add a value to the synonym multivalued attribute.
	 * @param newValue the value to add
	 */
	public void addToSynonym(Object newValue);

	/**
	 * Remove a value to the synonym multivalued attribute.
	 * @param newValue the value to remove
	 */
	...
	/**
	 * Init the providedQualification
	 * @param settings settings for the providedQualification ReferencesTable 
	 */
	public void initProvidedQualification(ReferencesTableSettings settings);

	/**
	 * Update the providedQualification
	 * @param newValue the providedQualification to update
	 * 
	 */
	public void updateProvidedQualification();

	/**
	 * Adds the given filter to the providedQualification edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the providedQualification table
	 * 
	 */
