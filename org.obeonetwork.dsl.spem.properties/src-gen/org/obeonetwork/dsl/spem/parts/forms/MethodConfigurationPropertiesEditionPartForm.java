 ...
 * 
 */
public class MethodConfigurationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, MethodConfigurationPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.MethodConfigurationPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.MethodConfiguration.Properties.name, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createDefaultViewFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.MethodConfigurationPropertiesEditionPart_DefaultViewLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.MethodConfiguration.Properties.defaultView, SpemViewsRepository.FORM_KIND));
