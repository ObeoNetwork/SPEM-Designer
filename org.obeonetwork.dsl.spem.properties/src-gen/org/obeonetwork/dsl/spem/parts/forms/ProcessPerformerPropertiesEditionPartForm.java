 ...
 * 
 */
public class ProcessPerformerPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ProcessPerformerPropertiesEditionPart {
	 ...
	 * 
	 */
	public ProcessPerformerPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(processPerformerStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == SpemViewsRepository.ProcessPerformer.Properties.linkedActivity) {
					return createLinkedActivityFlatComboViewer(parent, widgetFactory);
				}
				if (key == SpemViewsRepository.ProcessPerformer.Properties.linkedTaskUse) {
					return createLinkedTaskUseFlatComboViewer(parent, widgetFactory);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(SpemMessages.ProcessPerformerPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.kind, SpemViewsRepository.FORM_KIND));
		kind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.kind, SpemViewsRepository.FORM_KIND));
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.kind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKind()));
			}

		});
		kind.setID(SpemViewsRepository.ProcessPerformer.Properties.kind);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.kind, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.presentationName, SpemViewsRepository.FORM_KIND));
		...
		presentationName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.presentationName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, presentationName.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.presentationName, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.briefDescription, SpemViewsRepository.FORM_KIND));
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.briefDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, briefDescription.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.briefDescription, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.mainDescription, SpemViewsRepository.FORM_KIND));
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.mainDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, mainDescription.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.mainDescription, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.purpose, SpemViewsRepository.FORM_KIND));
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.purpose, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, purpose.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.purpose, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.guidance.setHelpText(propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.guidance, SpemViewsRepository.FORM_KIND));
		this.guidance.createControls(parent, widgetFactory);
		this.guidance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.guidance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"guidance", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.guidance,
	...
	protected void moveGuidance(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		guidance.refresh();
	}
	...
	protected void removeFromGuidance(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		guidance.refresh();
	}
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.metric.setHelpText(propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.metric, SpemViewsRepository.FORM_KIND));
		this.metric.createControls(parent, widgetFactory);
		this.metric.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.metric, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMetric() {
		...
		"metric", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.metric,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				metric.refresh();
			}
	...
	protected void moveMetric(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		metric.refresh();
	}
	...
	protected void removeFromMetric(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		metric.refresh();
	}
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.category.setHelpText(propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.category, SpemViewsRepository.FORM_KIND));
		this.category.createControls(parent, widgetFactory);
		this.category.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.category, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategory() {
		...
		"category", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.category,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				category.refresh();
			}
	...
	protected void moveCategory(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		category.refresh();
	}
	...
	protected void removeFromCategory(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		category.refresh();
	}
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.copyright, SpemViewsRepository.FORM_KIND));
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.copyright, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, copyright.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.copyright, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, SpemMessages.ProcessPerformerPropertiesEditionPart_AuthorLabel, SWT.NONE);
		...
		editAuthor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.author, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(authorList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.changeDate, SpemViewsRepository.FORM_KIND));
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.changeDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.changeDate, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.changeDescription, SpemViewsRepository.FORM_KIND));
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.changeDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDescription.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.changeDescription, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.version, SpemViewsRepository.FORM_KIND));
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.version, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.name, SpemViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.name, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, SpemMessages.ProcessPerformerPropertiesEditionPart_HasMultipleOccurrencesLabel, SWT.CHECK);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.hasMultipleOccurrences, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, SpemMessages.ProcessPerformerPropertiesEditionPart_IsOptionalLabel, SWT.CHECK);
		isOptional.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.isOptional, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isOptional.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.isOptional, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, SpemMessages.ProcessPerformerPropertiesEditionPart_IsPlannedLabel, SWT.CHECK);
		isPlanned.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.isPlanned, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isPlanned.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.isPlanned, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLinkedRoleUseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.linkedRoleUse.setHelpText(propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.linkedRoleUse, SpemViewsRepository.FORM_KIND));
		this.linkedRoleUse.createControls(parent, widgetFactory);
		this.linkedRoleUse.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.linkedRoleUse, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addLinkedRoleUse() {
		...
		"linkedRoleUse", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.linkedRoleUse,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveLinkedRoleUse(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.linkedRoleUse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		linkedRoleUse.refresh();
	}
	...
	protected void removeFromLinkedRoleUse(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.linkedRoleUse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		linkedRoleUse.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createLinkedActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_LinkedActivityLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.linkedActivity, SpemViewsRepository.FORM_KIND));
		linkedActivity = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.linkedActivity, SpemViewsRepository.FORM_KIND));
		widgetFactory.adapt(linkedActivity);
		...
		linkedActivity.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.linkedActivity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLinkedActivity()));
			}

		});
		linkedActivity.setID(SpemViewsRepository.ProcessPerformer.Properties.linkedActivity);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.linkedActivity, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createLinkedTaskUseFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.ProcessPerformerPropertiesEditionPart_LinkedTaskUseLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.linkedTaskUse, SpemViewsRepository.FORM_KIND));
		linkedTaskUse = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SpemViewsRepository.ProcessPerformer.Properties.linkedTaskUse, SpemViewsRepository.FORM_KIND));
		widgetFactory.adapt(linkedTaskUse);
		...
		linkedTaskUse.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPerformerPropertiesEditionPartForm.this, SpemViewsRepository.ProcessPerformer.Properties.linkedTaskUse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLinkedTaskUse()));
			}

		});
		linkedTaskUse.setID(SpemViewsRepository.ProcessPerformer.Properties.linkedTaskUse);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SpemViewsRepository.ProcessPerformer.Properties.linkedTaskUse, SpemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
