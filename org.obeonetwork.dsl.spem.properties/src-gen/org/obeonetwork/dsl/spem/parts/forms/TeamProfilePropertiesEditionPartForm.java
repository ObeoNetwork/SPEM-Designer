 ...
 * 
 */
public class TeamProfilePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, TeamProfilePropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.kind, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.presentationName, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.briefDescription, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.mainDescription, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.purpose, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.copyright, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, SpemMessages.TeamProfilePropertiesEditionPart_AuthorLabel, SWT.NONE);
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.changeDate, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.changeDescription, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.version, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.name, SpemViewsRepository.FORM_KIND));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, SpemMessages.TeamProfilePropertiesEditionPart_HasMultipleOccurrencesLabel, SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, SpemMessages.TeamProfilePropertiesEditionPart_IsOptionalLabel, SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, SpemMessages.TeamProfilePropertiesEditionPart_IsPlannedLabel, SWT.CHECK);
	...
	protected Composite createSuperTeamFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, SpemMessages.TeamProfilePropertiesEditionPart_SuperTeamLabel, propertiesEditionComponent.isRequired(SpemViewsRepository.TeamProfile.Properties.superTeam, SpemViewsRepository.FORM_KIND));
