 ...
 * 
 */
public interface TeamProfilePropertiesEditionPart {
	...
	/**
	 * Defines a new superTeam
	 * @param newValue the new superTeam to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the superTeam edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Init the teamRole
	 * @param settings settings for the teamRole ReferencesTable 
	 */
	public void initTeamRole(ReferencesTableSettings settings);

	/**
	 * Update the teamRole
	 * @param newValue the teamRole to update
	 * 
	 */
	public void updateTeamRole();

	/**
	 * Adds the given filter to the teamRole edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the teamRole table
	 * 
	 */
