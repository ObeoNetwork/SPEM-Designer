...
public class DisciplinePackagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (disciplinePackage.getName() != null && isAccessible(UmaViewsRepository.DisciplinePackage.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), disciplinePackage.getName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmaViewsRepository.DisciplinePackage.Properties.name == event.getAffectedEditor()) {
			disciplinePackage.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (SpemPackage.eINSTANCE.getMethodContentPackageableElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.DisciplinePackage.Properties.name)) {
