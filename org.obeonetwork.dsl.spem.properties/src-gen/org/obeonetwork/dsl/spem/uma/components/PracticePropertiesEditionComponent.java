...
public class PracticePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (practice.getPresentationName() != null && isAccessible(UmaViewsRepository.Practice.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getPresentationName()));
			
			if (practice.getBriefDescription() != null && isAccessible(UmaViewsRepository.Practice.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getBriefDescription()));
			
			if (practice.getMainDescription() != null && isAccessible(UmaViewsRepository.Practice.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getMainDescription()));
			
			if (practice.getPurpose() != null && isAccessible(UmaViewsRepository.Practice.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getPurpose()));
			...
			if (practice.getCopyright() != null && isAccessible(UmaViewsRepository.Practice.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getCopyright()));
			
			if (practice.getAuthor() != null && isAccessible(UmaViewsRepository.Practice.Properties.author))
				basePart.setAuthor(practice.getAuthor());
			
			if (practice.getChangeDate() != null && isAccessible(UmaViewsRepository.Practice.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEDate(), practice.getChangeDate()));
			
			if (practice.getChangeDescription() != null && isAccessible(UmaViewsRepository.Practice.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getChangeDescription()));
			
			if (practice.getVersion() != null && isAccessible(UmaViewsRepository.Practice.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getVersion()));
			
			if (practice.getName() != null && isAccessible(UmaViewsRepository.Practice.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getName()));
			
			if (isAccessible(UmaViewsRepository.Practice.Properties.variabilityType)) {
				basePart.initVariabilityType((EEnum) SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().getEType(), practice.getVariabilityType());
			}
			...
			if (practice.getAdditionalInfo() != null && isAccessible(UmaViewsRepository.Practice.Properties.additionalInfo))
				basePart.setAdditionalInfo(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getAdditionalInfo()));
			
			if (practice.getApplication() != null && isAccessible(UmaViewsRepository.Practice.Properties.application))
				basePart.setApplication(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getApplication()));
			
			if (practice.getBackground() != null && isAccessible(UmaViewsRepository.Practice.Properties.background))
				basePart.setBackground(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getBackground()));
			
			if (practice.getGoal() != null && isAccessible(UmaViewsRepository.Practice.Properties.goal))
				basePart.setGoal(practice.getGoal());
			
			if (practice.getLevelOfAdoption() != null && isAccessible(UmaViewsRepository.Practice.Properties.levelOfAdoption))
				basePart.setLevelOfAdoption(practice.getLevelOfAdoption());
			
			if (practice.getProblem() != null && isAccessible(UmaViewsRepository.Practice.Properties.problem))
				basePart.setProblem(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), practice.getProblem()));
			...
			basePart.addFilterToReferencedActivity(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.isContainedInReferencedActivityTable((EObject)element));
					return element instanceof Resource;
				}
			
			});
			basePart.addFilterToReferencedActivity(new EObjectFilter(SpemPackage.eINSTANCE.getActivity()));
			// Start of user code for additional businessfilters for referencedActivity
			// End of user code
			
			basePart.addFilterToContentReference(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.isContainedInContentReferenceTable((EObject)element));
					return element instanceof Resource;
				}
			
			});
			basePart.addFilterToContentReference(new EObjectFilter(SpemPackage.eINSTANCE.getMethodContentElement()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmaViewsRepository.Practice.Properties.presentationName == event.getAffectedEditor()) {
			practice.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.briefDescription == event.getAffectedEditor()) {
			practice.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.mainDescription == event.getAffectedEditor()) {
			practice.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.purpose == event.getAffectedEditor()) {
			practice.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (UmaViewsRepository.Practice.Properties.copyright == event.getAffectedEditor()) {
			practice.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				practice.getAuthor().clear();
				practice.getAuthor().addAll(((List) event.getNewValue()));
			}
		}
		if (UmaViewsRepository.Practice.Properties.changeDate == event.getAffectedEditor()) {
			practice.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEDate(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.changeDescription == event.getAffectedEditor()) {
			practice.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.version == event.getAffectedEditor()) {
			practice.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.name == event.getAffectedEditor()) {
			practice.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (UmaViewsRepository.Practice.Properties.additionalInfo == event.getAffectedEditor()) {
			practice.setAdditionalInfo((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.application == event.getAffectedEditor()) {
			practice.setApplication((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.background == event.getAffectedEditor()) {
			practice.setBackground((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.Practice.Properties.goal == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				practice.getGoal().clear();
				practice.getGoal().addAll(((List) event.getNewValue()));
			}
		}
		if (UmaViewsRepository.Practice.Properties.levelOfAdoption == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				practice.getLevelOfAdoption().clear();
				practice.getLevelOfAdoption().addAll(((List) event.getNewValue()));
			}
		}
		if (UmaViewsRepository.Practice.Properties.problem == event.getAffectedEditor()) {
			practice.setProblem((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.author)) {
				basePart.setAuthor(((Practice)semanticObject).getAuthor());
			}
			
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getMethodContentPackageableElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().equals(msg.getFeature()) && isAccessible(UmaViewsRepository.Practice.Properties.variabilityType))
			...
			if (UmaPackage.eINSTANCE.getPractice_AdditionalInfo().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.additionalInfo)) {
				if (msg.getNewValue() != null) {
					basePart.setAdditionalInfo(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
					basePart.setAdditionalInfo("");
				}
			}
			if (UmaPackage.eINSTANCE.getPractice_Application().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.application)) {
				if (msg.getNewValue() != null) {
					basePart.setApplication(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
					basePart.setApplication("");
				}
			}
			if (UmaPackage.eINSTANCE.getPractice_Background().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.background)) {
				if (msg.getNewValue() != null) {
					basePart.setBackground(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
					basePart.setBackground("");
				}
			}
			if (UmaPackage.eINSTANCE.getPractice_Goal().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.goal)) {
				basePart.setGoal(((Practice)semanticObject).getGoal());
			}
			
			if (UmaPackage.eINSTANCE.getPractice_LevelOfAdoption().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.levelOfAdoption)) {
				basePart.setLevelOfAdoption(((Practice)semanticObject).getLevelOfAdoption());
			}
			
			if (UmaPackage.eINSTANCE.getPractice_Problem().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.Practice.Properties.problem)) {
				if (msg.getNewValue() != null) {
					basePart.setProblem(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
					basePart.setProblem("");
				}
			}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (UmaViewsRepository.Practice.Properties.additionalInfo == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UmaPackage.eINSTANCE.getPractice_AdditionalInfo().getEAttributeType(), (String)newValue);
					}
				...
				if (UmaViewsRepository.Practice.Properties.application == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UmaPackage.eINSTANCE.getPractice_Application().getEAttributeType(), (String)newValue);
					}
				...
				if (UmaViewsRepository.Practice.Properties.background == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UmaPackage.eINSTANCE.getPractice_Background().getEAttributeType(), (String)newValue);
					}
				...
				if (UmaViewsRepository.Practice.Properties.problem == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(UmaPackage.eINSTANCE.getPractice_Problem().getEAttributeType(), (String)newValue);
					}
