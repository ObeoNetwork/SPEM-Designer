...
public class RoleSetPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (roleSet.getPresentationName() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getPresentationName()));
			
			if (roleSet.getBriefDescription() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getBriefDescription()));
			
			if (roleSet.getMainDescription() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getMainDescription()));
			
			if (roleSet.getPurpose() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getPurpose()));
			...
			if (roleSet.getCopyright() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getCopyright()));
			
			if (roleSet.getAuthor() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.author))
				basePart.setAuthor(roleSet.getAuthor());
			
			if (roleSet.getChangeDate() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEDate(), roleSet.getChangeDate()));
			
			if (roleSet.getChangeDescription() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getChangeDescription()));
			
			if (roleSet.getVersion() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getVersion()));
			
			if (roleSet.getName() != null && isAccessible(UmaViewsRepository.RoleSet.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), roleSet.getName()));
			
			if (isAccessible(UmaViewsRepository.RoleSet.Properties.variabilityType)) {
				basePart.initVariabilityType((EEnum) SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().getEType(), roleSet.getVariabilityType());
			}
			...
			basePart.addFilterToRole(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.isContainedInRoleTable((EObject)element));
					return element instanceof Resource;
				}
			
			});
			basePart.addFilterToRole(new EObjectFilter(SpemPackage.eINSTANCE.getRoleDefinition()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (UmaViewsRepository.RoleSet.Properties.presentationName == event.getAffectedEditor()) {
			roleSet.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.RoleSet.Properties.briefDescription == event.getAffectedEditor()) {
			roleSet.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.RoleSet.Properties.mainDescription == event.getAffectedEditor()) {
			roleSet.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.RoleSet.Properties.purpose == event.getAffectedEditor()) {
			roleSet.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (UmaViewsRepository.RoleSet.Properties.copyright == event.getAffectedEditor()) {
			roleSet.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.RoleSet.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				roleSet.getAuthor().clear();
				roleSet.getAuthor().addAll(((List) event.getNewValue()));
			}
		}
		if (UmaViewsRepository.RoleSet.Properties.changeDate == event.getAffectedEditor()) {
			roleSet.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEDate(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.RoleSet.Properties.changeDescription == event.getAffectedEditor()) {
			roleSet.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.RoleSet.Properties.version == event.getAffectedEditor()) {
			roleSet.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (UmaViewsRepository.RoleSet.Properties.name == event.getAffectedEditor()) {
			roleSet.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.author)) {
				basePart.setAuthor(((RoleSet)semanticObject).getAuthor());
			}
			
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getMethodContentPackageableElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(UmaViewsRepository.RoleSet.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().equals(msg.getFeature()) && isAccessible(UmaViewsRepository.RoleSet.Properties.variabilityType))
