 ...
 * 
 */
public class ConfigurationPackagePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ConfigurationPackagePropertiesEditionPart {
	 ...
	 * 
	 */
	public ConfigurationPackagePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(configurationPackageStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == UmaViewsRepository.ConfigurationPackage.Properties.ownedConfiguration) {
					return createOwnedConfigurationTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(UmaMessages.ConfigurationPackagePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.ConfigurationPackagePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ConfigurationPackage.Properties.name, UmaViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.ConfigurationPackage.Properties.name, UmaViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createOwnedMethodContentMemberTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedMethodContentMember = new ReferencesTable(UmaMessages.ConfigurationPackagePropertiesEditionPart_OwnedMethodContentMemberLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedMethodContentMember.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedMethodContentMember.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedMethodContentMember.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedMethodContentMember.refresh();
			}
		...
		this.ownedMethodContentMember.setHelpText(propertiesEditionComponent.getHelpContent(UmaViewsRepository.ConfigurationPackage.Properties.ownedMethodContentMember, UmaViewsRepository.FORM_KIND));
		...
		this.ownedMethodContentMember.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createReusedPackageReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.reusedPackage.setHelpText(propertiesEditionComponent.getHelpContent(UmaViewsRepository.ConfigurationPackage.Properties.reusedPackage, UmaViewsRepository.FORM_KIND));
		this.reusedPackage.createControls(parent, widgetFactory);
		this.reusedPackage.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.reusedPackage, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"reusedPackage", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.reusedPackage,
	...
	protected void moveReusedPackage(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		reusedPackage.refresh();
	}
	...
	protected void removeFromReusedPackage(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		reusedPackage.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOwnedConfigurationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedConfiguration = new ReferencesTable(UmaMessages.ConfigurationPackagePropertiesEditionPart_OwnedConfigurationLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedConfiguration.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedConfiguration.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedConfiguration.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedConfiguration.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ownedConfiguration.setHelpText(propertiesEditionComponent.getHelpContent(UmaViewsRepository.ConfigurationPackage.Properties.ownedConfiguration, UmaViewsRepository.FORM_KIND));
		this.ownedConfiguration.createControls(parent, widgetFactory);
		this.ownedConfiguration.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConfigurationPackagePropertiesEditionPartForm.this, UmaViewsRepository.ConfigurationPackage.Properties.ownedConfiguration, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
