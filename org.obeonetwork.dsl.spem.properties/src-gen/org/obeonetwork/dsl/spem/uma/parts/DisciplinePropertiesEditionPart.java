 ...
 * 
 */
public interface DisciplinePropertiesEditionPart {
	...
	/**
	 * Init the subCategory
	 * @param settings settings for the subCategory ReferencesTable 
	 */
	public void initSubCategory(ReferencesTableSettings settings);

	/**
	 * Update the subCategory
	 * @param newValue the subCategory to update
	 * 
	 */
	public void updateSubCategory();

	/**
	 * Adds the given filter to the subCategory edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the subCategory table
	 * 
	 */
	...
	/**
	 * Init the categorizedElement
	 * @param settings settings for the categorizedElement ReferencesTable 
	 */
	public void initCategorizedElement(ReferencesTableSettings settings);

	/**
	 * Update the categorizedElement
	 * @param newValue the categorizedElement to update
	 * 
	 */
	public void updateCategorizedElement();

	/**
	 * Adds the given filter to the categorizedElement edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the categorizedElement table
	 * 
	 */
	...
	/**
	 * Init the relatedTask
	 * @param settings settings for the relatedTask ReferencesTable 
	 */
	public void initRelatedTask(ReferencesTableSettings settings);

	/**
	 * Update the relatedTask
	 * @param newValue the relatedTask to update
	 * 
	 */
	public void updateRelatedTask();

	/**
	 * Adds the given filter to the relatedTask edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the relatedTask table
	 * 
	 */
	...
	/**
	 * Init the relatedWorflow
	 * @param settings settings for the relatedWorflow ReferencesTable 
	 */
	public void initRelatedWorflow(ReferencesTableSettings settings);

	/**
	 * Update the relatedWorflow
	 * @param newValue the relatedWorflow to update
	 * 
	 */
	public void updateRelatedWorflow();

	/**
	 * Adds the given filter to the relatedWorflow edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the relatedWorflow table
	 * 
	 */
