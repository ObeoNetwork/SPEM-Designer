 ...
 * 
 */
public interface ProcessPlanningTemplatePropertiesEditionPart {
	...
	/**
	 * Init the baseProcess
	 * @param settings settings for the baseProcess ReferencesTable 
	 */
	public void initBaseProcess(ReferencesTableSettings settings);

	/**
	 * Update the baseProcess
	 * @param newValue the baseProcess to update
	 * 
	 */
	public void updateBaseProcess();

	/**
	 * Adds the given filter to the baseProcess edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the baseProcess table
	 * 
	 */
