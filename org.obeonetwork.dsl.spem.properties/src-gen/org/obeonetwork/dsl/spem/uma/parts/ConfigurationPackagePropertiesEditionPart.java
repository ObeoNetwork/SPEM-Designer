 ...
 * 
 */
public interface ConfigurationPackagePropertiesEditionPart {
	...
	/**
	 * Update the ownedConfiguration
	 * @param newValue the ownedConfiguration to update
	 * 
	 */
	public void updateOwnedConfiguration();

	/**
	 * Adds the given filter to the ownedConfiguration edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the ownedConfiguration table
	 * 
	 */
