 ...
 * 
 */
public class SupportingMaterialPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, SupportingMaterialPropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.kind, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.presentationName, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.briefDescription, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.mainDescription, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.purpose, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.copyright, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, UmaMessages.SupportingMaterialPropertiesEditionPart_AuthorLabel, SWT.NONE);
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.changeDate, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.changeDescription, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.version, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.name, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createVariabilityTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_VariabilityTypeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.variabilityType, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_VariabilityBasedOnElementLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.variabilityBasedOnElement, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createMethodContentKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.SupportingMaterialPropertiesEditionPart_MethodContentKindLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.SupportingMaterial.Properties.methodContentKind, UmaViewsRepository.FORM_KIND));
