...
public interface DomainPropertiesEditionPart {
	...
	/**
	 * Init the relatedProduct
	 * @param settings settings for the relatedProduct ReferencesTable 
	 */
	public void initRelatedProduct(ReferencesTableSettings settings);

	/**
	 * Update the relatedProduct
	 * @param newValue the relatedProduct to update
	 * 
	 */
	public void updateRelatedProduct();

	/**
	 * Adds the given filter to the relatedProduct edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the relatedProduct table
	 * 
	 */
