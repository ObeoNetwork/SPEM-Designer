 ...
 * 
 */
public interface DeliverablePropertiesEditionPart {
	...
	/**
	 * Init the workProduct
	 * @param settings the combo setting
	 */
	public void initWorkProduct(EObjectFlatComboSettings settings);

	/**
	 * Defines a new workProduct
	 * @param newValue the new workProduct to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the workProduct edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Init the deliveredProduct
	 * @param settings settings for the deliveredProduct ReferencesTable 
	 */
	public void initDeliveredProduct(ReferencesTableSettings settings);

	/**
	 * Update the deliveredProduct
	 * @param newValue the deliveredProduct to update
	 * 
	 */
	public void updateDeliveredProduct();

	/**
	 * Adds the given filter to the deliveredProduct edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the deliveredProduct table
	 * 
	 */
	...
	/**
	 * Defines a new externalDescription
	 * @param newValue the new externalDescription to set
	 * 
	 */
	...
	/**
	 * @return the packagingGuidance
	 * 
	 */
	public String getPackagingGuidance();

	/**
	 * Defines a new packagingGuidance
	 * @param newValue the new packagingGuidance to set
	 * 
	 */
