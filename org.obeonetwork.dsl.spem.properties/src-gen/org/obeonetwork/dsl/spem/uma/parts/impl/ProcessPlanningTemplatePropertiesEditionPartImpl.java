...
public class ProcessPlanningTemplatePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProcessPlanningTemplatePropertiesEditionPart {
	...
	protected Composite createPreConditionMultiValuedEditor(Composite parent) {
		...
		editPreCondition.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_PreConditionLabel);
	...
	protected Composite createPostConditionMultiValuedEditor(Composite parent) {
		...
		editPostCondition.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_PostConditionLabel);
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.kind, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createPresentationNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.presentationName, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.briefDescription, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createMainDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.mainDescription, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createPurposeText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.purpose, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createCopyrightText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.copyright, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_AuthorLabel);
	...
	protected Composite createChangeDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.changeDate, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.changeDescription, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createVersionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.version, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.name, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_HasMultipleOccurrencesLabel);
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_IsOptionalLabel);
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_IsPlannedLabel);
	...
	protected Composite createIsRepeatableCheckbox(Composite parent) {
		...
		isRepeatable.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_IsRepeatableLabel);
	...
	protected Composite createIsOngoingCheckbox(Composite parent) {
		...
		isOngoing.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_IsOngoingLabel);
	...
	protected Composite createIsEventDrivenCheckbox(Composite parent) {
		...
		isEventDriven.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_IsEventDrivenLabel);
	...
	protected Composite createVariabilityTypeEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_VariabilityTypeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.variabilityType, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_VariabilityBasedOnElementLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.variabilityBasedOnElement, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createUseKindEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_UseKindLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.useKind, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createUsedActivityFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_UsedActivityLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.usedActivity, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createDefaultContextFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_DefaultContextLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.defaultContext, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createScopeText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_ScopeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.ProcessPlanningTemplate.Properties.scope, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createUsageNoteMultiValuedEditor(Composite parent) {
		...
		editUsageNote.setText(UmaMessages.ProcessPlanningTemplatePropertiesEditionPart_UsageNoteLabel);
