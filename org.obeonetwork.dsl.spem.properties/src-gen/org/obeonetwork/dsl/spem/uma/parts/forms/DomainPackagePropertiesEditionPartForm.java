 ...
 * 
 */
public class DomainPackagePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DomainPackagePropertiesEditionPart {
	 ...
	 * 
	 */
	public DomainPackagePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(UmaMessages.DomainPackagePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DomainPackagePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.DomainPackage.Properties.name, UmaViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.DomainPackage.Properties.name, UmaViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createOwnedMethodContentMemberTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedMethodContentMember = new ReferencesTable(UmaMessages.DomainPackagePropertiesEditionPart_OwnedMethodContentMemberLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedMethodContentMember.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedMethodContentMember.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedMethodContentMember.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedMethodContentMember.refresh();
			}
		...
		this.ownedMethodContentMember.setHelpText(propertiesEditionComponent.getHelpContent(UmaViewsRepository.DomainPackage.Properties.ownedMethodContentMember, UmaViewsRepository.FORM_KIND));
		...
		this.ownedMethodContentMember.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createReusedPackageReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.reusedPackage.setHelpText(propertiesEditionComponent.getHelpContent(UmaViewsRepository.DomainPackage.Properties.reusedPackage, UmaViewsRepository.FORM_KIND));
		this.reusedPackage.createControls(parent, widgetFactory);
		this.reusedPackage.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.reusedPackage, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"reusedPackage", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.reusedPackage,
	...
	protected void moveReusedPackage(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		reusedPackage.refresh();
	}
	...
	protected void removeFromReusedPackage(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DomainPackagePropertiesEditionPartForm.this, UmaViewsRepository.DomainPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		reusedPackage.refresh();
	}
