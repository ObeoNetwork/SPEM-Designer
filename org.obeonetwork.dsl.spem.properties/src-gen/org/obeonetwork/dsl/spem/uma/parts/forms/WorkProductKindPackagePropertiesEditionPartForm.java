 ...
 * 
 */
public class WorkProductKindPackagePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, WorkProductKindPackagePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.WorkProductKindPackagePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.WorkProductKindPackage.Properties.name, UmaViewsRepository.FORM_KIND));
