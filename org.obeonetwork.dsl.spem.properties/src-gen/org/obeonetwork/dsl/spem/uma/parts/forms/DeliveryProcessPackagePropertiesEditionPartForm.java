 ...
 * 
 */
public class DeliveryProcessPackagePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DeliveryProcessPackagePropertiesEditionPart {
	 ...
	 * 
	 */
	public DeliveryProcessPackagePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(UmaMessages.DeliveryProcessPackagePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliveryProcessPackagePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.DeliveryProcessPackage.Properties.name, UmaViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeliveryProcessPackagePropertiesEditionPartForm.this, UmaViewsRepository.DeliveryProcessPackage.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.DeliveryProcessPackage.Properties.name, UmaViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createOwnedProcessMemberTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedProcessMember = new ReferencesTable(UmaMessages.DeliveryProcessPackagePropertiesEditionPart_OwnedProcessMemberLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeliveryProcessPackagePropertiesEditionPartForm.this, UmaViewsRepository.DeliveryProcessPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedProcessMember.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeliveryProcessPackagePropertiesEditionPartForm.this, UmaViewsRepository.DeliveryProcessPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedProcessMember.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeliveryProcessPackagePropertiesEditionPartForm.this, UmaViewsRepository.DeliveryProcessPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedProcessMember.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeliveryProcessPackagePropertiesEditionPartForm.this, UmaViewsRepository.DeliveryProcessPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedProcessMember.refresh();
			}
		...
		this.ownedProcessMember.setHelpText(propertiesEditionComponent.getHelpContent(UmaViewsRepository.DeliveryProcessPackage.Properties.ownedProcessMember, UmaViewsRepository.FORM_KIND));
		...
		this.ownedProcessMember.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeliveryProcessPackagePropertiesEditionPartForm.this, UmaViewsRepository.DeliveryProcessPackage.Properties.ownedProcessMember, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
