 ...
 * 
 */
public class CapabilityPatternPackagePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CapabilityPatternPackagePropertiesEditionPart {
...
protected List<ViewerFilter> ownedProcessMemberFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public CapabilityPatternPackagePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(UmaMessages.CapabilityPatternPackagePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.CapabilityPatternPackagePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.CapabilityPatternPackage.Properties.name, UmaViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CapabilityPatternPackagePropertiesEditionPartImpl.this, UmaViewsRepository.CapabilityPatternPackage.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.CapabilityPatternPackage.Properties.name, UmaViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createOwnedProcessMemberAdvancedTableComposition(Composite parent) {
		this.ownedProcessMember = new ReferencesTable(UmaMessages.CapabilityPatternPackagePropertiesEditionPart_OwnedProcessMemberLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CapabilityPatternPackagePropertiesEditionPartImpl.this, UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedProcessMember.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CapabilityPatternPackagePropertiesEditionPartImpl.this, UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedProcessMember.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CapabilityPatternPackagePropertiesEditionPartImpl.this, UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedProcessMember.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CapabilityPatternPackagePropertiesEditionPartImpl.this, UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedProcessMember.refresh();
			}
		...
		this.ownedProcessMember.setHelpText(propertiesEditionComponent.getHelpContent(UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember, UmaViewsRepository.SWT_KIND));
		...
		this.ownedProcessMember.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CapabilityPatternPackagePropertiesEditionPartImpl.this, UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
