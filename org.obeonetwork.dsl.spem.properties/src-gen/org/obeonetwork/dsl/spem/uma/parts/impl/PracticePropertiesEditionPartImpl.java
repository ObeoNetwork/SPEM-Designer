...
public class PracticePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PracticePropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.kind, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createPresentationNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.presentationName, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.briefDescription, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createMainDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.mainDescription, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createPurposeText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.purpose, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createCopyrightText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.copyright, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(UmaMessages.PracticePropertiesEditionPart_AuthorLabel);
	...
	protected Composite createChangeDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.changeDate, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.changeDescription, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createVersionText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.version, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.name, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createVariabilityTypeEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_VariabilityTypeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.variabilityType, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_VariabilityBasedOnElementLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.variabilityBasedOnElement, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createMethodContentKindFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_MethodContentKindLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.methodContentKind, UmaViewsRepository.SWT_KIND));
	...
	protected Composite createAdditionalInfoText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_AdditionalInfoLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.additionalInfo, UmaViewsRepository.SWT_KIND));
		additionalInfo = new Text(parent, SWT.BORDER);
	...
	protected Composite createApplicationText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_ApplicationLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.application, UmaViewsRepository.SWT_KIND));
		application = new Text(parent, SWT.BORDER);
	...
	protected Composite createBackgroundText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_BackgroundLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.background, UmaViewsRepository.SWT_KIND));
		background = new Text(parent, SWT.BORDER);
	...
	protected Composite createGoalMultiValuedEditor(Composite parent) {
		goal = new Text(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editGoal.setText(UmaMessages.PracticePropertiesEditionPart_GoalLabel);
	...
	protected Composite createLevelOfAdoptionMultiValuedEditor(Composite parent) {
		levelOfAdoption = new Text(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editLevelOfAdoption.setText(UmaMessages.PracticePropertiesEditionPart_LevelOfAdoptionLabel);
	...
	protected Composite createProblemText(Composite parent) {
		SWTUtils.createPartLabel(parent, UmaMessages.PracticePropertiesEditionPart_ProblemLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Practice.Properties.problem, UmaViewsRepository.SWT_KIND));
		problem = new Text(parent, SWT.BORDER);
