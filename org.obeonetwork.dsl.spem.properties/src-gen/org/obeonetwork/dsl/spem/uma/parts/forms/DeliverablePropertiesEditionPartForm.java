 ...
 * 
 */
public class DeliverablePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DeliverablePropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.kind, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_PresentationNameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.presentationName, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_BriefDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.briefDescription, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_MainDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.mainDescription, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_PurposeLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.purpose, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_CopyrightLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.copyright, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, UmaMessages.DeliverablePropertiesEditionPart_AuthorLabel, SWT.NONE);
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_ChangeDateLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.changeDate, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_ChangeDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.changeDescription, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.version, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.name, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, UmaMessages.DeliverablePropertiesEditionPart_HasMultipleOccurrencesLabel, SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, UmaMessages.DeliverablePropertiesEditionPart_IsOptionalLabel, SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, UmaMessages.DeliverablePropertiesEditionPart_IsPlannedLabel, SWT.CHECK);
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronizedWithSource = widgetFactory.createButton(parent, UmaMessages.DeliverablePropertiesEditionPart_IsSynchronizedWithSourceLabel, SWT.CHECK);
	...
	protected Composite createWorkProductFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_WorkProductLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.workProduct, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createExternalDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_ExternalDescriptionLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.externalDescription, UmaViewsRepository.FORM_KIND));
	...
	protected Composite createPackagingGuidanceText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UmaMessages.DeliverablePropertiesEditionPart_PackagingGuidanceLabel, propertiesEditionComponent.isRequired(UmaViewsRepository.Deliverable.Properties.packagingGuidance, UmaViewsRepository.FORM_KIND));
