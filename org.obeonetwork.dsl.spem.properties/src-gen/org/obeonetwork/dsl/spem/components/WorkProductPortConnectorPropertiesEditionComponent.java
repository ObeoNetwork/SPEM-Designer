...
public class WorkProductPortConnectorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (workProductPortConnector.getPresentationName() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getPresentationName()));
			
			if (workProductPortConnector.getBriefDescription() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getBriefDescription()));
			
			if (workProductPortConnector.getMainDescription() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getMainDescription()));
			
			if (workProductPortConnector.getPurpose() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getPurpose()));
			...
			if (workProductPortConnector.getCopyright() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getCopyright()));
			
			if (workProductPortConnector.getAuthor() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.author))
				basePart.setAuthor(workProductPortConnector.getAuthor());
			
			if (workProductPortConnector.getChangeDate() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEDate(), workProductPortConnector.getChangeDate()));
			
			if (workProductPortConnector.getChangeDescription() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getChangeDescription()));
			
			if (workProductPortConnector.getVersion() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getVersion()));
			
			if (workProductPortConnector.getName() != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), workProductPortConnector.getName()));
			...
			basePart.addFilterToConnectedPort(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.isContainedInConnectedPortTable((EObject)element));
					return element instanceof Resource;
				}
			
			});
			basePart.addFilterToConnectedPort(new EObjectFilter(SpemPackage.eINSTANCE.getWorkProductPort()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SpemViewsRepository.WorkProductPortConnector.Properties.presentationName == event.getAffectedEditor()) {
			workProductPortConnector.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.briefDescription == event.getAffectedEditor()) {
			workProductPortConnector.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.mainDescription == event.getAffectedEditor()) {
			workProductPortConnector.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.purpose == event.getAffectedEditor()) {
			workProductPortConnector.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.WorkProductPortConnector.Properties.copyright == event.getAffectedEditor()) {
			workProductPortConnector.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				...
				workProductPortConnector.getAuthor().addAll(((List) event.getNewValue()));
			}
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.changeDate == event.getAffectedEditor()) {
			workProductPortConnector.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEDate(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.changeDescription == event.getAffectedEditor()) {
			workProductPortConnector.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.version == event.getAffectedEditor()) {
			workProductPortConnector.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.WorkProductPortConnector.Properties.name == event.getAffectedEditor()) {
			workProductPortConnector.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.author)) {
				basePart.setAuthor(((WorkProductPortConnector)semanticObject).getAuthor());
			}
			
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getProcessPackageableElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.WorkProductPortConnector.Properties.name)) {
				if (msg.getNewValue() != null) {
