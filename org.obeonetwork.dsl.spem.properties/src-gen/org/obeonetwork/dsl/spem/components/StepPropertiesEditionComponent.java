...
public class StepPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (step.getPreCondition() != null && isAccessible(SpemViewsRepository.Step.Properties.preCondition))
				basePart.setPreCondition(step.getPreCondition());
			
			if (step.getPostCondition() != null && isAccessible(SpemViewsRepository.Step.Properties.postCondition))
			...
			if (step.getPresentationName() != null && isAccessible(SpemViewsRepository.Step.Properties.presentationName))
				basePart.setPresentationName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getPresentationName()));
			
			if (step.getBriefDescription() != null && isAccessible(SpemViewsRepository.Step.Properties.briefDescription))
				basePart.setBriefDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getBriefDescription()));
			
			if (step.getMainDescription() != null && isAccessible(SpemViewsRepository.Step.Properties.mainDescription))
				basePart.setMainDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getMainDescription()));
			
			if (step.getPurpose() != null && isAccessible(SpemViewsRepository.Step.Properties.purpose))
				basePart.setPurpose(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getPurpose()));
			...
			if (step.getCopyright() != null && isAccessible(SpemViewsRepository.Step.Properties.copyright))
				basePart.setCopyright(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getCopyright()));
			
			if (step.getAuthor() != null && isAccessible(SpemViewsRepository.Step.Properties.author))
				basePart.setAuthor(step.getAuthor());
			
			if (step.getChangeDate() != null && isAccessible(SpemViewsRepository.Step.Properties.changeDate))
				basePart.setChangeDate(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEDate(), step.getChangeDate()));
			
			if (step.getChangeDescription() != null && isAccessible(SpemViewsRepository.Step.Properties.changeDescription))
				basePart.setChangeDescription(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getChangeDescription()));
			
			if (step.getVersion() != null && isAccessible(SpemViewsRepository.Step.Properties.version))
				basePart.setVersion(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getVersion()));
			
			if (isAccessible(SpemViewsRepository.Step.Properties.variabilityType)) {
				basePart.initVariabilityType((EEnum) SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().getEType(), step.getVariabilityType());
			}
			...
			if (step.getName() != null && isAccessible(SpemViewsRepository.Step.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), step.getName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SpemViewsRepository.Step.Properties.presentationName == event.getAffectedEditor()) {
			step.setPresentationName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.Step.Properties.briefDescription == event.getAffectedEditor()) {
			step.setBriefDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.Step.Properties.mainDescription == event.getAffectedEditor()) {
			step.setMainDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.Step.Properties.purpose == event.getAffectedEditor()) {
			step.setPurpose((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.Step.Properties.copyright == event.getAffectedEditor()) {
			step.setCopyright((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.Step.Properties.author == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				step.getAuthor().clear();
				step.getAuthor().addAll(((List) event.getNewValue()));
			}
		}
		if (SpemViewsRepository.Step.Properties.changeDate == event.getAffectedEditor()) {
			step.setChangeDate((java.util.Date)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEDate(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.Step.Properties.changeDescription == event.getAffectedEditor()) {
			step.setChangeDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (SpemViewsRepository.Step.Properties.version == event.getAffectedEditor()) {
			step.setVersion((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (SpemViewsRepository.Step.Properties.name == event.getAffectedEditor()) {
			step.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (SpemPackage.eINSTANCE.getWorkDefinition_PreCondition().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.preCondition)) {
				basePart.setPreCondition(((Step)semanticObject).getPreCondition());
			}
			
			if (SpemPackage.eINSTANCE.getWorkDefinition_PostCondition().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.postCondition)) {
				basePart.setPostCondition(((Step)semanticObject).getPostCondition());
			}
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_PresentationName().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.presentationName)) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_BriefDescription().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.briefDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_MainDescription().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.mainDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Purpose().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.purpose)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Copyright().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.copyright)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Author().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.author)) {
				basePart.setAuthor(((Step)semanticObject).getAuthor());
			}
			
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDate().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.changeDate)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_ChangeDescription().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.changeDescription)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getDescribableElement_Version().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.version)) {
				if (msg.getNewValue() != null) {
			...
			if (SpemPackage.eINSTANCE.getVariabilityElement_VariabilityType().equals(msg.getFeature()) && isAccessible(SpemViewsRepository.Step.Properties.variabilityType))
			...
			if (SpemPackage.eINSTANCE.getStep_Name().equals(msg.getFeature()) && basePart != null && isAccessible(SpemViewsRepository.Step.Properties.name)) {
				if (msg.getNewValue() != null) {
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (SpemViewsRepository.Step.Properties.name == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(SpemPackage.eINSTANCE.getStep_Name().getEAttributeType(), (String)newValue);
					}
