...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.spem.ProcessParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SpemPackage.Literals.PROCESS_PARAMETER__PARAMETER_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOptionalityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProcessParameter_optionality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProcessParameter_optionality_feature", "_UI_ProcessParameter_type"),
				 SpemPackage.Literals.PROCESS_PARAMETER__OPTIONALITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ProcessParameter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessParameter_type") :
			getString("_UI_ProcessParameter_type") + " " + label;
	}
