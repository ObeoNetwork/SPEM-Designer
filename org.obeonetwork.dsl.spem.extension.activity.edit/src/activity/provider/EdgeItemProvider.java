...
import org.obeonetwork.dsl.spem.provider.BreakdownElementItemProvider;

/**
 * This is the item provider adapter for a {@link activity.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_guard_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_guard_feature", "_UI_Edge_type"),
				 ActivityPackage.Literals.EDGE__GUARD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivityPackage.Literals.EDGE__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivityPackage.Literals.EDGE__TARGET,
				 true,
				 false,
				 true,
				 null,
