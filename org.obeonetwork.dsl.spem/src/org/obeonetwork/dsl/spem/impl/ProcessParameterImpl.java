 ...
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getPresentationName <em>Presentation Name</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getMainDescription <em>Main Description</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getGuidance <em>Guidance</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getProcessKind <em>Process Kind</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#isHasMultipleOccurrences <em>Has Multiple Occurrences</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#isIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#isIsPlanned <em>Is Planned</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getPlanningData <em>Planning Data</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getParameterType <em>Parameter Type</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.spem.impl.ProcessParameterImpl#getOptionality <em>Optionality</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessParameterImpl extends WorkDefinitionParameterImpl implements ProcessParameter {
	...
	public EList<Guidance> getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList<Guidance>(Guidance.class, this, SpemPackage.PROCESS_PARAMETER__GUIDANCE);
		}
		return guidance;
	}
	...
	public EList<Metric> getMetric() {
		if (metric == null) {
			metric = new EObjectResolvingEList<Metric>(Metric.class, this, SpemPackage.PROCESS_PARAMETER__METRIC);
		}
		return metric;
	}
	...
	public EList<Category> getCategory() {
		if (category == null) {
			category = new EObjectWithInverseResolvingEList.ManyInverse<Category>(Category.class, this, SpemPackage.PROCESS_PARAMETER__CATEGORY, SpemPackage.CATEGORY__CATEGORIZED_ELEMENT);
		}
		return category;
	}
	...
	public EList<String> getAuthor() {
		if (author == null) {
			author = new EDataTypeUniqueEList<String>(String.class, this, SpemPackage.PROCESS_PARAMETER__AUTHOR);
		}
		return author;
	}
